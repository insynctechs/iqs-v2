...
function loadWebPreview(site, tier, customimage) {
    ...
    var imgUrl = '//image.thum.io/get/width/' + width + '/auth/' + auth + '/' + url; var custompath = document.getElementById('hdnSrhRootPath').value + 'preview_images//';
